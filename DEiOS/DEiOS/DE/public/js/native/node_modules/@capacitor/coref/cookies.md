...
The Capacitor Cookies API provides native cookie support via patching `document.cookie` to use native libraries. It also provides methods for modifying cookies at a specific url. This plugin is bundled with `/js/native/node_modules/@capacitor/coref/dist/index.js`.
...
```typescript
import { CapacitorCookies } from '/js/native/node_modules/@capacitor/coref/dist/index.js';
