...
Yanfly.Param.UpdateRealScale = true;

console.log("UpdateRealScale:", Yanfly.Param.UpdateRealScale);
...
Yanfly.openConsole = function() {
  ...
  if (Utils.isOptionValid('test')) {
    ...
    // Capacitor doesn't support opening dev tools directly
    // You can use console.log for debugging
    console.log("Dev tools would be opened here.");
    window.focus();
  }
};
...
SceneManager.onKeyDown = function(event) {
  if (!event.ctrlKey && !event.altKey && event.keyCode === 116) {
    if (Utils.isOptionValid('test')) {
      ...
      // Capacitor doesn't support closing dev tools directly
      console.log("Dev tools would be closed here.");
    }
  }
