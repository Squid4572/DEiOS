    ...
    try {
        ...
        for (var i = 0; i < names.length; i++) {
            ...
            try {
                ...
                console.error('An error occurred while saving the mapshot', error);
            }
        }
        ...
        if (process.platform == 'win32' && $._openedFolder === undefined) {
            ...
            setTimeout(function() {
                // Capacitor doesn't support opening file explorer directly
                console.log('Mapshot saved to ' + longPath);
            }, 100);
        } else {
