...
StorageManager.loadGreenworks = async function() {
    try {
        const greenworksModule = await import('./greenworks.js');
        this.greenworks = greenworksModule.default || greenworksModule;
    } catch (e) {
